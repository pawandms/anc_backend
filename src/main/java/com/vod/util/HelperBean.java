...
import com.vod.enums.CollectionType;
import com.vod.enums.DepartmentType;
import com.vod.enums.EntityType;
import com.vod.enums.ExtensionType;
import com.vod.enums.ExternalSystemType;
import com.vod.enums.GenderType;
import com.vod.enums.HLSPropertyType;
import com.vod.enums.MediaStreamType;
import com.vod.enums.OsType;
import com.vod.enums.PeopleType;
import com.vod.enums.HlsPlayListType;
import com.vod.enums.ImageType;
import com.vod.enums.ImportStatusType;
import com.vod.enums.MediaGenreType;
import com.vod.enums.RepresentationType;
import com.vod.enums.SequenceType;
import com.vod.enums.StatusType;
import com.vod.event.model.EventLog;
import com.vod.exception.ConversionException;
import com.vod.exception.CountryException;
...
import com.vod.exception.LanguageException;
...
import com.vod.importer.model.TmdbCast;
import com.vod.importer.model.TmdbCollection;
import com.vod.importer.model.TmdbCrew;
import com.vod.importer.model.TmdbMovie;
import com.vod.importer.model.TmdbMovieCredit;
import com.vod.importer.model.TmdbPerson;
import com.vod.importer.model.TranslationImport;
import com.vod.importer.model.YouTubeImportRequest;
import com.vod.importer.model.YouTubeMedia;
import com.vod.importer.model.YouTubeMediaInfo;
...
import com.vod.msg.enums.MsgAttachmentType;
import com.vod.msg.enums.MsgBoxType;
...
import com.vod.msg.model.ChnlMsgAttribute;
...
import com.vod.msg.vo.ChannelUser;
import com.vod.msg.vo.CreateChannelVo;
	 ...
	 * @throws InvalidMasterPlayListException 
	  ...
	  public HlsVideo processHlsMediaFiles(String movieId, Path videoPath) throws HlsProcessingException 
	  {
	    ...
	    public String getSequanceNo(SequenceType type) throws SequencerException
	    {
	    	...
	    	seqStr = String.valueOf(seqNo)+"_"+year;
		...
		public SignInResp convertAuthResponseToSignInResp(ResponseEntity<OAuth2AccessToken> authRespEntity) throws ConversionException
		{
			...
			try {
				...
				if(!authRespEntity.getStatusCode().equals(HttpStatus.OK))
				{
					...
					resp.setAccessToken(token.getValue());
